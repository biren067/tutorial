...
function javaScript() {
  const topics = [
        {'Basic':[ {'Var Vs let Vs Const':{'status':'Done','desc':['Created venv,project and  launched server']}},
  ...
  return (
    <>
        ...
        <h1 className='text-center font-bold text-yellow-300 underline'>Javascript</h1>
